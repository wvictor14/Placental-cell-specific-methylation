...
# CNV calling output
CNV_segments <- readRDS('../../data/main/interim/12_CNV_segments.rds')
CNV_bins <- readRDS('../../data/main/interim/12_CNV_bins.rds')
chrom_lengths <- readRDS('../../data/main/interim/12_chrom_lengths.rds')
```
