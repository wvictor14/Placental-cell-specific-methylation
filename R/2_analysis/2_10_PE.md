...
## 1       2.64            1.82              3.72 1.11e-  6 TRUE   6.67e-  6
## 2       2.33            1.88              2.86 4.92e- 13 TRUE   9.83e- 13
## 3       1.81            0.930             3.19 4.89e-  2 FALSE  3.91e-  1
## 4       8.17            6.86              9.77 8.99e-122 TRUE   8.99e-122
## 5       2.22            1.78              2.74 1.88e- 11 TRUE   5.63e- 11
## 6       1.49            1.21              1.81 1.73e-  4 TRUE   1.21e-  3
## 7       1.98            1.58              2.46 8.68e-  9 TRUE   3.47e-  8
## 8       1.66            1.36              2.01 7.87e-  7 TRUE   3.93e-  6
...
```
## Warning: Expected 3 pieces. Missing pieces filled with `NA` in 8 rows [1, 2, 3,
## 4, 5, 6, 7, 8].
```
...
```
## # A tibble: 4 x 4
##   Group1          total  n_pe  p_pe
##   <chr>           <int> <int> <dbl>
## 1 Third.Endo_cs   75525   109 0.202
## 2 Third.Hofb_cs  130733   131 0.243
## 3 Third.Strom_cs  80153   105 0.194
## 4 Third.Troph_cs 135553   147 0.272
```
...
![](2_10_PE_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](2_10_PE_files/figure-html/unnamed-chunk-6-2.png)<!-- -->
...
![](2_10_PE_files/figure-html/unnamed-chunk-6-3.png)<!-- -->
...
![](2_10_PE_files/figure-html/unnamed-chunk-6-4.png)<!-- -->
...
![](2_10_PE_files/figure-html/unnamed-chunk-6-5.png)<!-- -->
...
![](2_10_PE_files/figure-html/unnamed-chunk-6-6.png)<!-- -->
