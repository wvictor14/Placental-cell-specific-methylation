...
* NIH EPIC Batch 2 week 1 sample sheet.csv - sample sheet for week 1 samples (not used)
* NIH EPIC Batch 2 sample sheet.xlsx - final sample sheet created after week 2

Main - interim

* 01_rgset.rds - generated from 01_load_data, raw unprocessed rg channelset object of first week 
samples
